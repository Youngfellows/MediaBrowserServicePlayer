...
public class MediaNotificationManager extends BroadcastReceiver {
    ...
    private String createNotificationChannel(String channelId, String channelName){
        ...
        NotificationManager service = (NotificationManager) mService.getSystemService(Context.NOTIFICATION_SERVICE);
    ...
    private Notification createNotification() {
        ...
        Notification.Builder notificationBuilder = new Notification.Builder(mService,channelId);
